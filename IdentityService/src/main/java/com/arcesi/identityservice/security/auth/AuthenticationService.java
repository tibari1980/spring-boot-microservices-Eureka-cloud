...
public class AuthenticationService {
  ...
  private final com.arcesi.identityservice.security.config.JwtService jwtService;
  ...
  public AuthenticationResponse authenticate(AuthenticationRequest request) {
    ...
    var user = repository.findUserBeanByEmail(request.getEmail())
        .orElseThrow();
    var jwtToken = jwtService.generateToken(user);
    var refreshToken = jwtService.generateRefreshToken(user);
  ...
  public void refreshToken(
    ...
    if (userEmail != null) {
      var user = this.repository.findUserBeanByEmail(userEmail)
              .orElseThrow();
